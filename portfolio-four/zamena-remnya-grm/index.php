...
<head>
	...
	<title>Замена ремня ГРМ в Минске</title>
				...
				<div>
					...
					<div class="slider-content">
						<div class="text-center">
							<p>Замена ремня грм</p>
							<p>ПО<span class="text-red"> НИЗКОЙ ЦЕНЕ!</span></p>
							<div class="red-block">Профессиональный ремонт автомобилей, низкие цены!</div>
						</div>
					</div>
				</div>
			</div>
