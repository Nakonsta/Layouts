...
<head>
	...
	<title>«Мегасервис» Тех. жидкости</title>
    ...
    <link rel="stylesheet" href="/zapchasti_tehn/css/style.css">
	...
	<div id="wrap">
		...
		<div class="wrap-home-slider">
			...
			<div class="home-slider home-slider_top">
				<div>
					<img class="img_header" src="../img/content/zapchasti_tehn/header.jpg" alt="">                      
					<div class="slider-content">
						<div class="text-center">
                            <img src="../img/content/zapchasti_filtr/5.png" alt="">
                            <p>ЗАМЕНА ТЕХНИЧЕСКИХ </p>
                            <p>ЖИДКОСТЕЙ <span class="text-red">ЗА 20 МИНУТ</span></p>
...
<div class="block_card">
    ...
    <div class="drop"></div>
		...
		<div class="container">
            ...
            <!-- services -->
			<div class="services">
				<div class="title">ЗАМЕНА ТЕХНИЧЕСКИХ ЖИДКОСТЕЙ АВТОМОБИЛЯ</div>
				...
				<div class="row wrap-services mobile-row">
					<div class="col-xs-6 col-md-3">
						<a href="#" class="services-block">
							...
							<span class="services-text">Замена жидкостей гидроусилителя</span>
						</a>
					</div>
					<div class="col-xs-6 col-md-3">
						<a href="#" class="services-block">
							<img src="/img/content/yslygi/18.png">
							<span class="services-text">Замена охлаждающей жидкости</span>
						</a>
					</div>
					<div class="col-xs-6 col-md-3">
						<a href="#" class="services-block">
							<img src="/img/content/yslygi/16.png">
							<span class="services-text">Замена тормозной жидкости</span>
						</a>
					</div>
					<div class="col-xs-6 col-md-3">
						<a href="#" class="services-block">
							<img src="/img/content/yslygi/11.png">
							<span class="services-text">Замена масла двигателя</span>
						</a>
					</div>
				</div>
			</div>
