...
<head>
	...
	<title>Ошибка 404. Вы ошиблись страницей, вернитесь на сайт Megaservice.by</title>
        ...
        <div class="header__fixed">
            <div class="container">
                <div class="col-sm-2 col-lg-2 col-md-2 col-xs-2 header__fixed_logo_contanier">
				    <div class="logo"><a href="/"><img src="/img/logo.png" alt="Логотип сто автосервиса Автосеть" title="Логотип Автосеть" class="img-responsive"></a></div>
				</div>
	...
	<div id="wrap" class="error-page">
		<div class="wrap-home-slider wrap-home-slider-small">
				...
				<div class="container">
					<div class="row mobile-row">
						<div class="col-sm-5 col-lg-5 col-md-4 col-xs-6">
							<div class="logo"><a href="/"><img src="/img/logo.png" alt="Автосервис Автосеть логотип"  title="Автосервис Автосеть логотип" class="img-responsive"></a></div>
            ...
            <div class="home-slider home-slider-small">
                <div>
                    <img src="/img/404.jpg" alt="Автосервис Автосеть в Минске" title="Ждём в нашем автосервисе">
                    <div class="slider-content home-slider-content">
                    <div class="text-center home-slider-wrapper">
                            <h1 class="home-slider-h1"><span class="error-background">Ошибка 404</span></h1>
                            <div class="parallelogram-wrapper">
                                <div class="red-block parallelogram parallelogram-gray"></div>
                                <span class="red-block-text">Страницы не существует. Проверьте адрес страницы.</span>
                            </div>                            
                        </div>
                    </div>
                </div>
