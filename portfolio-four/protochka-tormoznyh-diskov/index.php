<?php 
    ...
    $from='Мегасервис ПРОТОЧКА дисков заявка'; 
...
<head>
    ...
    <title>Проточка тормозных дисков от Мегасервис</title>
    ...
    <div id="wrap">
        ...
        <div class="wrap-home-slider">
            ...
            <div class="home-slider">
                ...
                <div>
                    ...
                    <img src="/img/content/protochka-tormoznyh-diskov/header.png" alt="">

                    <div class="slider-content">

                        <div class="text-center">

                            <p>Профессиональная проточка</p>

                            <p> <span class="text-red">ТОРМОЗНЫХ ДИСКОВ</span></p>
        ...
        <div class="container">
            ...
            <div class="free-block">
                ...
                <span class="sprites i-map-oil"></span>

                <div class="free-text"><span class="text-red">Самые низкие цены на проточку дисков </span>в центре Минска!</div>
            ...
            <div class="services">
                ...
                <div class="title">Профессиональная проточка тормозных дисков в Минске</div>

                <p>Наша компания предлагает услугу по проточке тормозных дисков со снятием или без снятия в Минске. Автосервис оснащен современным оборудованием, что позволяет гарантировать высокое качество, оперативность и выгодные цены. Работы выполняют опытные специалисты, имеющие высокую квалификацию, которые соблюдают все рекомендации производителей.  </p>
				
				<p>Решение проточить тормозные диски является оптимальным с точки зрения цены и эффективности ремонта. Суть процедуры заключается обработке диска с целью восстановления идеально ровной поверхности и параллельного положения относительно колодок.  </p>

                <p><strong>МегаСервис предоставляет весь спектр услуг по ремонту тормозной системы:</strong></p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        ...
                        <ul class="red_list">
                            ...
                            <li><a href="">Замена тормозных трубок</a></li>

                            <li><a href="">Замена тормозного цилиндра</a></li>

                            <li><a href="">Замена тормозных шлангов и жидкостей</a></li>

                            <li><a href="">Ремонт суппортов</a></li>

                            <li><a href="">Замена тормозных колодок и дисков</a></li>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table price-table">
                            ...
                            <tr>
                                ...
                                <th>Стомость услуги</th>

                                <th>Цена со скидкой до 15.08.2019</th>
                            ...
                            <tr>
                                ...
                                <td>Проточка тормозного диска (мы снимаем и устанавливаем)</td>

                                <td>35 руб.</td>

                                <td><span class="text-red">29 руб.</span></td>
                            ...
                            <tr>
                                ...
                                <td>Проточка тормозного диска (прямо на автомобиле)</td>
                            ...
                            <tr>
                                ...
                                <td>Проточка тормозного диска (без автомобиля)</td>

                                <td>30 руб.</td>

                                <td><span class="text-red">24 руб.</span></td>
                ...
                <div class="price-buttons">
                    ...
                    <p>Закажите проточку тормозных дисков на этой неделе и получите <span class="text-red">скидку до 25%</span></p>
            ...
            <div class="wrap-comparison">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="title__comparison">До проточки</div>

                        <div class="img__comparison text-center">

                            <img src="/img/content/protochka-tormoznyh-diskov/before.png"  alt="">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="title__comparison red">После проточки</div>

                        <div class="img__comparison text-center">

                            <img src="/img/content/protochka-tormoznyh-diskov/after.png"  alt="">
            ...
            <div class="text-block">
                ...
                <p>В процессе эксплуатации тормозные диски изнашиваются и подвергаются высоким нагрузкам. Со временем на них образуются дефекты, которые приводят к появлению вибрации, посторонних звуков и снижению эффективности торможения. При первых признаках неисправности необходимо срочно обратиться к специалистам. Это позволит избежать дорогостоящего ремонта и обеспечит безопасность при езде.</p>

               <p>Неисправность тормозной системы приводит к рискам при вождении. Увеличение тормозного пути может привести к аварийной ситуации. При небольшой степени износа диск можно отремонтировать, путем проточки. Серьезное повреждение можно исправить путем замены детали.</p>

               <p><strong>Для чего выполняют проточку</strong></p>

               <p>Повреждение тормозных дисков со временем приводит к неисправности других деталей и узлов:</p>
               <ul>
	           <li>подшипника ступицы;</li>
	           <li>шаровых опор;</li>
	           <li>шаровых соединений;</li>
	           <li>рулевой рейки.</li>
               </ul>
               <p>Если своевременно не устранить неисправность тормозной системы, владелец столкнется с необходимостью покупки дополнительных деталей и с расходами на их замену. Но главное &ndash; в любой момент тормоза могут отказать, что грозит опасностью возникновения аварийной ситуации.</p>

               <p>Проточка позволяет восстановить нормальную работу тормозной системы и снизить ее износ, не потратив большие деньги на проведение ремонта. Может выполняться проточка тормозных дисков без снятия диска или отдельно снятых дисков. Без снятия – менее трудоемкая процедура, а соответственно – более дешевая, ее она не всегда целесообразна. Способ ремонта определяет наш специалист и дает рекомендацию, что позволяет повысить его качество.</p>

               <p><strong>Как выполняется проточка</strong></p>
			   
			   <p>Решение проточить тормозные диски является оптимальным с точки зрения цены и эффективности ремонта. Суть процедуры заключается обработке диска с целью восстановления идеально ровной поверхности и параллельного положения относительно колодок. </p>
			   
			   <p>Наш центр проводит профессиональную проточку дисков. Цена процедуры невысокая, занимает она мало времени, обычно не более часа. У нас вы получаете: </p>
			   
			   <ul type="circle">
               <li>возможность устранения дефектов на дисках любой марки авто;</li>
	           <li>обработку со снятием диска или без;</li>
	           <li>проточку с двух сторон диска;</li>
	           <li>замену колодок;</li>
	           <li>экономию времени на ремонт;</li>
	           <li>повышение эффективности тормозной системы;</li>
	           <li>профессиональный подход и оперативность.</li>
               </ul>
               <p>Современное оборудование нашего центра гарантирует высокую точность проведения работ. Наши мастера проводят предварительный осмотр и анализ диска на повреждение, определяют целесообразность проточки и метод выполнения работ.</p>
			   <p>Проточка передних тормозных дисков – эффективная процедура, которая стоит недорого и не отнимет много времени. В результате заказчик получает восстановленную поверхность диска. Это повышает безопасность езды за счет сокращения тормозного пути и улучшения торможения в целом.</p>
...
.mob_map{
  ...
  <link rel="stylesheet" href="/css/jquery.fancybox.min.css">
    ...
    <link rel="stylesheet" href="/protochka-tormoznyh-diskov/css/style.css">
