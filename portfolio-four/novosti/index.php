...
<head>
	...
	<title>Новости. Автосервис в Минске - ремонт авто в СТО «Мегасервис»</title>
...
<body>
	...
	<div id="wrap" class="home-page">
        ...
        <div class="container news news-page">
        ...
        <div class="container pagination-wrapper">
            ...
            <span class="pagination-begin">Первый отзыв</span>
            <span class="pagination-pages">Показано с 1 по 9 из 146</span>
