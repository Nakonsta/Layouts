<?php 
    ...
    // $from - от кого 
    $from='Мегасервис ремонт тормозов заявка'; 
...
<head>
	...
	<title>Ремонт тормозной системы в Минске</title>
...
<!--  Clickcease.com tracking-->
	...
	<div id="wrap">
				...
				<div>
					...
					<div class="slider-content">
                        ...
                        <div class="text-center">
                            ...
                            <p><span class="text-black">Ремонт тормозной</span></p>

                            <p> <span class="text-red">системы в Минске</span></p>

							<div class="red-block">Качественная диагностика и ремонт от МЕГАСЕРВИС</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			...
			<!-- services -->
			<div class="services">
				<div class="title">Ремонт и диагностика тормозной системы в Минске</div>
				<p>Самого тщательного осмотра, внимания владельца авто требует тормозная система, от которой зависит его и пассажиров безопасность. Даже мелкие неисправности в этой системе не должны игнорироваться, их следует ремонтировать срочно! Без «самодеятельности», поручив ремонт профессионалам.</p>
			...
			<h3>Признаки неисправности тормозной системы</h3>
				<div><span style="font-size:16px">Хотя у различных автомобилей «реакция» на неисправность тормозной системы – разная, есть общехарактерные ее признаки, проявляющиеся, например, пульсацией, скрипом, неравномерным изнашиванием колодок. Даже опытные профессионалы предпочитают обращаться в диагностическую лабораторию (на станцию), заметив признаки неисправности:	</span></div>

<ol>
	<li><span style="font-size:16px">увеличение тормозного пути;</span></li>
	<li><span style="font-size:16px">регулярные «провалы», неоправданный рост свободного хода педали или ее излишняя жесткость;</span></li>
	<li><span style="font-size:16px">«уход машины в сторону» при торможении (ведь износ тормозных накладок – неравномерный, и разогреваются они неравномерно);</span></li>
	<li><span style="font-size:16px">нехарактерные для торможения звуки, скрипы, пульсации, биения;</span></li>
	<li><span style="font-size:16px">колодки от диска не «отлипают»;</span></li>
	<li><span style="font-size:16px">увеличение нормативного расхода тормозной жидкости (из-за повреждений шлангов, трубок системы или вздутий, трещин на них);</span></li>
	<li><span style="font-size:16px">снижение эффективности «ручника», подсистемы ABS (в частности, беспричинное загорание и потухание ее лампочки при нажатии педали) и др.</span></li>
</ol>
<div><span style="font-size:16px">Ремонт тормозов, возможно, потребует первоочередных, неотложных работ, компьютерной диагностики.</span></div>

<h3>Перечень ремонтных услуг</h3> 

<div><span style="font-size:16px">Автосервисом предлагается базовый комплекс ремонтных процедур:</span></div>
<ol>
	<li><span style="font-size:16px">визуальный осмотр, проверка дисков;</span></li>
	<li><span style="font-size:16px">регулировка и замена колодок, суппортов, направляющих, цилиндров сцепления, шлангов, тросов, прокачка тормозов;</span></li>
	<li><span style="font-size:16px">прокачка тормозов и др.</span></li>
	<li><span style="font-size:16px">замена или проточка тормозных дисков;</span></li>
	<li><span style="font-size:16px">замена тормозных колодок;</span></li>
	<li><span style="font-size:16px">замена тормозных шлангов и трубок, аргонная сварка;</span></li>
	<li><span style="font-size:16px">замена тормозной жидкости.</span></li>
</ol>     
            </div>
			<!-- /text-block -->
			<!-- consultation -->
