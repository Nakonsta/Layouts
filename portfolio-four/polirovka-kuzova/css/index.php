...
<p>Наша компания поможет сохранить внешний вид вашего автомобиля в превосходном состоянии на долгие годы. Мы проводим профессиональную полировку с соблюдением все норм и правил. Мы гарантируем высокое качество цены ниже, чем у конкурентов. Каждый визит к нам продлевает ресурс кузова и позволяет сэкономить на его ремонте.</p>
    ...
    <script type="text/javascript">
        ymaps.ready(init);
              ...
              myGeoObject2 = new ymaps.GeoObject(2);
			  myMap.geoObjects
			  .add(new ymaps.Placemark([53.843341365709335,27.526644059999974], {
			     balloonContent: 'Минск, ул. Корженевского 16В'
			  }, {
			     // Опции.
			        // Необходимо указать данный тип макета.
			        iconLayout: 'default#image',
			        // Своё изображение иконки метки.
			        iconImageHref: '/img/content/himchistka-salona-avto-2/i-map.png',
			        // Размеры метки.
			        iconImageSize: [100, 127],
			        // Смещение левого верхнего угла иконки относительно
			        // её "ножки" (точки привязки).
			        iconImageOffset: [-45, -140]
			  }));
              
              myGeoObject3 = new ymaps.GeoObject(3);
			  myMap.geoObjects
			  .add(new ymaps.Placemark([53.939931730629674,27.52737169499993], {
			     balloonContent: 'Минск, ул. Нововиленская 48'
			  }, {
			     // Опции.
			        // Необходимо указать данный тип макета.
			        iconLayout: 'default#image',
              ...
              myGeoObject4 = new ymaps.GeoObject(4);
			  myMap.geoObjects
			  .add(new ymaps.Placemark([53.831631080719134,27.69430562499997], {
			     balloonContent: 'Минск, ул. Селицкого 39Б'
			  }, {
			     // Опции.
			        // Необходимо указать данный тип макета.
			        iconLayout: 'default#image',
