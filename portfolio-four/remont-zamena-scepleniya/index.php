<?php 
    ...
    $from='Мегасервис замена сцепления заявка'; 
...
<head>
	...
	<title>Замена и ремонт сцепления в Минске</title>
	<meta name="description" content="Ремонтируем и, при необходимости, заменим сцепления автомобиля. Большой опыт, современное оорудование и доступные цены. По всем вопросам звоните: +375 (29) 627-44-88">
	<meta name="keywords" content="сцепление ремонт замента автомобиль сервис Минск заказать недорого стоимость цены">
	...
	<div id="wrap">
		...
		<div class="wrap-home-slider">
			...
			<div class="home-slider">
				...
				<div>
					...
					<img src="/img/content/remont-zamena-scepleniya/header.png" alt="">

					<div class="slider-content">

						<div class="text-center">

							<p>Замена и ремонт сцепления</p>

							<p> <span class="text-red">В центре Минска</span></p>

							<div class="red-block">Профессиональный ремонт по низким ценам!</div>
		...
		<div class="container">
			...
			<div class="services">
				...
				<div class="title"><h1 style="font-weight: bold;font-size:24px;">Ремонт сцепления по самым низким ценам в центре Минска (ТЦ Корона Кальварийская)</h1></div>

				<p>Мы обслуживаем автомобили всех современных марок. Наши специалисты обладают колоссальными знаниями в данной сфере услуг, в сочетание с огромным опытом, это позволит обслужить ваше транспортное средство быстро и качественно. Если приключилась беда и автомобиль вышел из строя, смело обращайтесь в наш автосервис.</p>
				...
				<div class="row wrap-services mobile-row">
					...
					<div class="col-xs-12 col-sm-4">
						...
						<a href="#" class="services-block">
							...
							<img src="/img/content/remont-zamena-scepleniya/1.png" alt="">
					...
					<div class="col-xs-12 col-sm-4">
						...
						<a href="http://megaservice.by/remont-startera-generatora/" class="services-block">

							<img src="/img/content/remont-zamena-scepleniya/2.png" alt="">

							<span class="services-text">Ремонт и замена стартера/генератора</span>
					...
					<div class="col-xs-12 col-sm-4">
						...
						<a href="http://megaservice.by/protochka-tormoznyh-diskov/" class="services-block">
							...
							<img src="/img/content/remont-zamena-scepleniya/3.png" alt="">
				...
				<div class="row wrap-services mobile-row">	
					...
					<div class="col-xs-12 col-sm-4">
						...
						<a href="http://megaservice.by/diagnostika-remont-podveski/" class="services-block">
							...
							<img src="/img/content/remont-zamena-scepleniya/4.png" alt="">

							<span class="services-text">Диагностика и ремонт подвески (диагностика бесплатно)</span>
					...
					<div class="col-xs-12 col-sm-4">
						...
						<a href="http://megaservice.by/shinomontazh/" class="services-block">

							<img src="/img/content/remont-zamena-scepleniya/5.png" alt="">

							<span class="services-text">Услуги шиномонтажа (раскатка/правка дисков)</span>
					...
					<div class="col-xs-12 col-sm-4">
						...
						<a href="#" class="services-block">
							...
							<img src="/img/content/remont-zamena-scepleniya/6.png" alt="">

							<span class="services-text">Сварочные работы (все виды сварочных работ)</span>
			...
			<!-- price -->
			<div class="price">
				<div class="title text-center">Стоимость ремонта и замены сцепления</div>
				<div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table price-table">
                                ...
                                <tr>
                                    <td>02.</td>
                                    <td>Замена / Ремонт сцепления</td>
                                    <td>Самые низкие цены в Минске!</td>
                                    <td>от 100 руб.</td>
                                </tr>
								<tr>
                                    <td>03.</td>
                                    <td>Комплект сцепления в сборе</td>
                                    <td>Большой выбор запчастей в наличии!</td>
                                    <td>от 57 руб.</td>
                                </tr>
								<tr>
                                    <td>04.</td>
				...
				<div class="price-buttons">
					...
					<p>Запишитесь на ремонт сцепления сегодня <span class="text-red">и получи скидку 10%</span></p>
			...
			<div class="wrap-consultation">
				...
				<div class="title-big title-big-consultation">ЗАПИСАТЬСЯ <i>на замену/ремонт сцепления вы можете по телефонам:</i></div>
...
<h2><span>Замена сцепления или ремонт</span></h2>
<p>Сцепление &ndash; это механизм, который служит для включения, выключения передачи коробки передач. Когда вы выжимаете педаль, специальные лепестки пружин плотно придавливают друг к другу&nbsp;диск сцепления и нажимной диск. Благодаря этому соединению, они начинают вращаться с одинаковой скоростью. С исправным сцепление передачи переключаются плавно и автомобиль трогается с места без рывков.</p>
<p><br>Возникшие неполадки можно выявить по внешним признакам. Но не всегда этого достаточно, так как один и тот же признак может возникать при разных неисправностях. Конкретная неисправность в этом случае выявляется при разборке.</p>
<h2>Внешние признаки неполадок в сцеплении:</h2>
<p><br>&bull;&emsp;неполное выключение;<br>&bull;&emsp;неполное включение;<br>&bull;&emsp;в процессе работы сцепления появляются рывки;<br>&bull;&emsp;вибрация во время включения сцепления;<br>&bull;&emsp;посторонний шум во время выключения сцепления.</p>
<p><br>Если пришла пора ремонтировать автомобиль, доверьте это дело профессионалам. Заменив сцепление на СТО, вы получите гарантию качества осуществленных работ и адекватную цену за услуги.</p>
<h2>Виды неисправностей сцепления и их ремонт</h2>
<p><br>&bull;&emsp;Заклинил выключающий привод<br>&bull;&emsp;Вышли из строя прижимные пластины<br>&bull;&emsp;Искривился выжимной диск<br>&bull;&emsp;Износились фрикционные накладки<br>&bull;&emsp;Течет главный цилиндр</p>
<p><br>К сожалению, в тот или иной момент ваше транспортное средство может выйти из строя. От этого никто не застрахован, в независимости от срока службы автомобиля. В таком случае вам может понадобиться помощь экспертов. И мы вам эту помощь окажем. Наш автосервис производит диагностику на современном оборудование, а ремонтные работы выполняются только квалифицированными специалистами.</p>
<p><br>Вот далеко не полный список работ, оказываемых нашим сервисом, если у вас возникли проблемы со сцеплением:</p>
<p><br>&bull;&emsp;замена диска&nbsp;<br>&bull;&emsp;замена выжимного подшипника<br>&bull;&emsp;замена либо ремонт главного цилиндра&nbsp;</p>
<p><br>Ждем вас в нашем автосервисе, для диагностики и ремонта неисправностей узла сцепления вашего автомобиля. Мы в самые сжатые сроки, вернем вашему автомобиля былую прыть!</p>
...
.mob_map{
	...
	<link rel="stylesheet" href="/remont-zamena-scepleniya/css/style.css">
