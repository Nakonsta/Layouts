<?php 
    ...
    // $from - от кого 
    $from='Мегасервис ремонт рулевой рейки'; 
...
<head>
	...
	<title>Ремонт и замена рулевых реек в Минске</title>
	<meta name="description" content="Предлагаем услуги по ремонту или замене рулевых реек в Минске. Работаем профессионально, быстро и недорого. По всем вопросам звоните: +375 (29) 627-44-88">
	<meta name="keywords" content="рейка рулевая ремонт замента автомобиль сервис Минск заказать недорого стоимость цены">
	...
	<div id="wrap">
		...
		<div class="wrap-home-slider">
			...
			<div class="home-slider">
				<div>
					<img src="/img/content/remont-rulevoj-rejki/header.png" alt="">
					<div class="slider-content">
						<div class="text-center">
							<p>Ремонт и замена</p>
							<p> рулевых реек<span class="text-red"> в Минске</span></p>
		...
		<div class="container">
			...
			<div class="free-block">
				...
				<div class="free-text"><span class="text-red">БЕСПЛАТНО</span> Компьютерная диагностика! при ремонте рулевой рейки у нас!</div>

			</div>
			<!-- /free -->
			<!-- services -->
			<div class="services">
				<div class="title"><h1 style="font-weight: bold;font-size:24px;">Ремонт и восстановление рулевых реек в Минске</h1></div>
				<p>Наша компания осуществляет восстановление всех типов рулевых реек, независимо от их состояния. Диагностические и ремонтные работы производятся высококвалифицированными специалистами, с огромным опытом работы в данной сфере. При обращении в наш сервисный центр, мы обеспечим качественное обслуживание в короткие сроки. </p> 
				<p>Мы предоставляем гарантию на выполненные работы, срок которой зависит от трудоемкости проведенных мероприятий, а также общего состояния транспортного средства и всех его элементов, работа которых, связана с функционированием рулевого механизма. </p>
				<div class="row wrap-services mobile-row">
					<div class="col-xs-12 col-sm-4">
						<a href="#" class="services-block">
							<img src="/img/content/remont-rulevoj-rejki/1.png" alt="">
							<span class="services-text">Компьютерная диагностика (выявим причину поломки)</span>
						</a>
					</div>
					<div class="col-xs-12 col-sm-4">
						<a href="#" class="services-block">
							<img src="/img/content/remont-rulevoj-rejki/2.png" alt="">
							<span class="services-text">Ремонт и замена стартера (ремонт в течении 2-х часов)</span>
						</a>
					</div>
					<div class="col-xs-12 col-sm-4">
						<a href="#" class="services-block">
							<img src="/img/content/remont-rulevoj-rejki/3.png" alt="">
			...
			<!-- price -->
			<div class="price">
				<div class="title text-center"><h2>Цены на ремонт и замену реек</h2></div>
				<div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table price-table">
                                ...
                                <tr>
                                    <td>02.</td>
                                    <td>Снятие установка рулевой рейки</td>
                                    <td></td>
                                    <td>от 100 руб.</td>
                                </tr>
								<tr>
								...
								<tr>
                                    <td>04.</td>
                                    <td>Восстановление рулевой рейки</td>
                                    <td></td>
                                    <td>от 180 руб.</td>
                                </tr>
								<tr>
				...
				<div class="price-buttons">
					<p>Закажите любое услугу из списка на этой неделе и получите <span class="text-red">СКИДКУ 15%!</span></p>
					<p>
			...
			<div class="wrap-consultation">
				<div class="title-big title-big-consultation">ЗАПИСАТЬСЯ <i>на замену рулевой рейки вы можете по телефонам:</i></div>
		...
		<h2><span>Замена рулевых реек (электрических и гидравлических)</span></h2>
<p>Основным предназначением рулевого механизма является - преобразование вращательного усилия, получаемого от поворота руля, в отклонение передних колес по горизонтали.</p>
<h2><span>Неисправности рулевой рейки и ее ремонт</span></h2>
<ol>
	<li>Следы подтеков гидравлической жидкости, в месте, где располагается рулевая гайка. Возможно образование небольшой лужи, под местом расположения рулевой рейки, после долгой стоянки автомобиля.</li>
	<li>Рулевой механизм хуже воспринимает команды водителя. Необходимо провести диагностические работы с помощью специального испытательного стенда. Принцип его работы заключается в создании необходимого давления на рулевую рейку.</li>
	<li>Сальники пропускают гидравлическую жидкость, совместно с появлением коррозии на поверхностях рулевой рейке. При возникновении данных неисправностей, необходимо проводить ремонтные работы рулевого механизма. В состав этих работ входит: замена сальников, втулок, уплотнительных колец и других расходных материалов. Место появления коррозии подвергается шлифовке, после чего наносится термическое напыления, для восстановления изначального размера изделия.</li>
	<li>Наблюдается наличие люфта во время вращения руля, а также характерно смещается колесо в сторону. Восстановленная рулевая рейка проходит этап тестирования перед установкой в автомобиль.</li>
	<li>Характерные стуки появляются из области расположения рулевого механизма, которые также отдаются в рулевое колесо. Данные симптомы присущи для неисправностей отдельных элементов рулевой рейки.</li>
</ol>
<p>Данный механизм является очень важным агрегатом автомобиля, поскольку от его функционирования зависит безопасность дорожного движения. Поэтому необходимо постоянно контролировать состояние рулевого механизма и, при появлении каких-либо симптомов неисправности, обратиться на станцию технического обслуживания для проведения диагностики.</p>
<h2><span>Принцип работ по ремонту рулевого механизма </span></h2>
<p>Перед проведением ремонтных работ, осуществляется чистка всех поверхностей рулевой рейки от грязи и пыли. После этого проводится диагностика неисправностей, которая помогает точно определить элементы, которые подлежат замене.</p>
<p>В первую очередь осуществляется полная разборка рулевого механизма и визуальная оценка состояния всех агрегатов механизма. В обязательном порядке, необходимо заменить резиновые уплотнители и подшипники при разборке рулевой рейки. После этого производится проверка технических параметров деталей, которые находились в механизме, а также которые подлежат установке в него. Полученные показатели должны соответствовать требованиям завода-изготовителя. Изделие, которое функционирует в нормальном режиме, но его параметры не соответствуют заданным требованиям, подлежит замене.</p>
<p>После работ по восстановлению рулевого механизма, его устанавливают на испытательный стенд, функцией которого является повторение работы рулевого управления автомобиля. При нормальном функционировании, восстановленный узел устанавливают обратно на авто. Также, по окончании всех типов работ, необходимо производить замену жидкости в гидроусилителе и осуществить ее прокачку в системе.</p>
			 </div>
			<!-- /text-block -->
			<!-- gallery -->
				...
				<div>
					<div class="review-block clearfix">
						...
						<div class="review-text">
							...
							<div class="name">Андрей Корташов <span class="text-red">44</span></div>
							<div class="review-text-block">
								<p>«Ребята профессионалы своего дела. Обратился с проблеммой по рулевой рейке, вопрос решили в течении суток. Отремонтировали и дали гарантию. Цены...смешные! Рекомендую.»</p>
							</div>
							<div class="post-date">23 апреля 2017</div>
						</div>
					</div>
				</div>
				<div>
					<div class="review-block clearfix">
						...
						<div class="review-text">
							<p><i>OOO "Логистик-Партнер" менеджер</i></p>
							<div class="name">Виталий Румянцев <span class="text-red">25</span></div>
							<div class="review-text-block">
								<p>«Работаем с ребятами на постоянной основе, сотрудничеством довольны. Выполняют любые, даже самые сложные ремотные услуги. Цены ооочень демократичные.»</p>
							</div>
							<div class="post-date">16 июня 2017</div>
						</div>
					</div>
				</div>
				<div>
...
.mob_map{
	...
	<link rel="stylesheet" href="/remont-rulevoj-rejki/css/style.css">
	<!-- form -->
